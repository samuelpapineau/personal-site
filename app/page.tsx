		...
		<>
			...
			<div id="about"className="about">
				...
				<div className="about-list">
					...
					<a className="about-link" href="spyglass.network" target="_blank"> Spyglass Network website</a> as mentioned in the projects section.</li>
					...
					Substreams: <a className="about-link" href="" target="_blank">GitHub Repository.</a></li>
					<li>Worked on a data sink that extracts, parses, and validates Substreams inscriptions data and
					passes it to an API: <a className="about-link" href="" target="_blank">GitHub Repository.</a></li>
				</div>
